...
def _node_must_be_preserved(node, tree):
    """Return True when a node must survive domain prune.

    Keeps nodes already referenced from /chosen (standard DT) and explicit
    Zephyr memory-region nodes.
    """
